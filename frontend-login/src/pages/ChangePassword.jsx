      ...
      <div className="card shadow-sm border-0">
        <div className="card-body p-4">
          ...
          <div className="alert alert-warning small py-2 mb-3">
            Heads up: your backend doesn't verify "Old Password" against
            your account, and currently stores the new password
            unencrypted. You may be logged out and need to sign in again
            after this.
          </div>
