  ...
  useEffect(() => {
    ...
    async function fetchProfile() {
      try {
        ...
        if (isMounted) {
          setServerError(err.response?.data?.message || 'Unable to load your profile.');
        }
      } finally {
  ...
  const validate = () => {
    ...
    if (!currentPassword) {
      errors.currentPassword =
        'Required: this backend rewrites the password on every save (see code comment).';
    }
      ...
      <div className="card shadow-sm border-0">
        <div className="card-body p-4">
          ...
          <div className="alert alert-warning small py-2 mb-3">
            Your current password is required to save any change here, and
            saving will re-write it. If your backend team hasn't patched
            UserServiceImpl to re-hash passwords on update yet, you may be
            asked to log in again afterward.
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="mb-3">
              ...
              <div className="form-text">
                Changing your email invalidates your current session token
                (it's signed for the old email) - you'll need to log in
                again afterward.
              </div>
            </div>
